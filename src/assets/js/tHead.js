let tHead = [
    { name: "Id", index : "id", validation : { type : "number"}, style : {background : "cadetblue", color : "white"}  },
    { name: "Image", index: "Image" , validation : { type : "image"} },
    { name: "DOB", index: "birth", validation : { type : "date",input : "dd-mm-yy"}, style : {background : "cadetblue", color : "white"} },
